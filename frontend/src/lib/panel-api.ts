...
export type AdminFinancialTransactionDetail = AdminFinancialTransactionsResponse['items'][number] & {
  isCommissionSnapshotted?: boolean;
  providerNote?: string | null;
  refundStatus?: string;
  booking?: AdminFinancialTransactionsResponse['items'][number]['booking'] & {
    professional?: {
      id: string;
      title: string | null;
      slug: string | null;
