  ...
  return (
    <div className={`space-y-5 rounded-2xl border ${navy.border} bg-white p-4`}>
      ...
      <div className={`border-t ${navy.border} pt-4`}>
        ...
        {!showAddOnForm ? <button type="button" onClick={() => setShowAddOnForm(true)} className={`text-sm font-medium ${navy.title}`}>+ افزودن ویژگی از کاتالوگ</button> : <div className="space-y-2">
