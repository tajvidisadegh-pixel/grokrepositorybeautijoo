...
class NotifyUsersDto {
  @ApiProperty({ type: [String], description: 'لیست شناسه کاربران' })
  @IsArray()
  @ArrayMinSize(1)
  @ArrayMaxSize(500)
  userIds: string[];
  ...
  @ApiPropertyOptional({ description: 'ارسال SMS هم انجام شود؟' })
  @IsOptional()
  @IsBoolean()
  sms?: boolean;
}
...
export class AdminController {
  ...
  // --- User Management (#53 customers) ---
  @Get('users')
  @ApiOperation({ summary: 'فهرست مشتریان (پیش‌فرض) با جستجو و فیلتر' })
  listUsers(
  ...
  @ApiOperation({ summary: 'ارسال اعلان/SMS به لیست مشخص کاربران (#53)' })
