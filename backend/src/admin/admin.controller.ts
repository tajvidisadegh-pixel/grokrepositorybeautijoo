...
export class AdminController {
  ...
  updateServiceCategory(@Param('id') id: string, @Body() dto: CatalogCategoryPatchDto, @CurrentUser('id') actorId?: string) {
  ...
  updateCatalogService(@Param('id') id: string, @Body() dto: CatalogServicePatchDto, @CurrentUser('id') actorId?: string) {
